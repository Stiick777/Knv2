    ...
    async function serbot() {
        ...
        if (methodCode && !conn.authState.creds.registered) {
            ...
            setTimeout(async () => {
               ...
               let txt = '*✪ S U B B O T - K A N B O T ✪*\n\n';
txt += '*𝑈𝑠𝑎 𝑒𝑠𝑡𝑒 𝐶ó𝑑𝑖𝑔𝑜 𝑝𝑎𝑟𝑎 𝑐𝑜𝑛𝑣𝑒𝑟𝑡𝑖𝑟𝑡𝑒 𝑒𝑛 𝑢𝑛 𝑆𝑢𝑏 𝐵𝑜𝑡*\n';
txt += '`1 :` 𝐻𝑎𝑔𝑎 𝑐𝑙𝑖𝑐𝑘 𝑒𝑛 𝑙𝑜𝑠 3 𝑝𝑢𝑛𝑡𝑜𝑠\n';
txt += '`2 :` 𝑇𝑜𝑞𝑢𝑒 𝑑𝑖𝑠𝑝𝑜𝑠𝑖𝑡𝑖𝑣𝑜𝑠 𝑣𝑖𝑛𝑐𝑢𝑙𝑎𝑑𝑜𝑠\n';
txt += '`3 :` 𝑆𝑒𝑙𝑒𝑐𝑐𝑖𝑜𝑛𝑎 𝑉𝑖𝑛𝑐𝑢𝑙𝑎𝑟 𝑐𝑜𝑛 𝑒𝑙 𝑛ú𝑚𝑒𝑟𝑜 𝑑𝑒 𝑡𝑒𝑙é𝑓𝑜𝑛𝑜\n';
txt += '`4 :` 𝐸𝑠𝑐𝑟𝑖𝑏𝑎 𝑒𝑙 𝐶𝑜𝑑𝑖𝑔𝑜\n';
txt += '> *𝑵𝒐𝒕𝒂:* 𝑬𝒔𝒕𝒆 𝑪ó𝒅𝒊𝒈𝒐 𝒔𝒐𝒍𝒐 𝒇𝒖𝒏𝒄𝒊𝒐𝒏𝒂 𝒆𝒏 𝒆𝒍 𝒏ú𝒎𝒆𝒓𝒐 𝒒𝒖𝒆 𝒍𝒐 𝒔𝒐𝒍𝒊𝒄𝒊𝒕𝒐.\n';

              let imgUrl = 'https://i.ibb.co/SKKdvRb/code.jpg'; // Imagen a enviar    

// Enviar mensaje con imagen y botón    
await parent.sendButton2(m.chat, txt, "⚡ KanBot", imgUrl, [], codeBot, null, m);      
                rl.close();
            }, 3000);
        }
        conn.isInit = false;
        ...
        setInterval(async () => {
            if (!conn.user) {
                try {
                    conn.ws.close();
                } catch {}conn.ev.removeAllListeners();
                let i = global.conns.indexOf(conn);
                if (i < 0) return;
                delete global.conns[i];
                global.conns.splice(i, 1);
