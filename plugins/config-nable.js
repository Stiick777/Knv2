...
toggleSetting(chat, 'antiBot', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiBot2', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'delete', isEnable, type, isAll, m)
break
...
toggleSetting(bot, 'autobio', isEnable, type, isAll, m)
break 
...
toggleSetting(chat, 'antiTiktok', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiYoutube', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiTelegram', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiFacebook', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiInstagram', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiTwitter', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiDiscord', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiThreads', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiTwitch', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'modohorny', isEnable, type, isAll, m)         
break
...
toggleSetting(chat, 'autolevelup', isEnable, type, isAll, m)         
break
...
toggleSetting(chat, 'antiPorn', isEnable, type, isAll, m)         
break

case 'nyimak':
isAll = true
if (!isROwner) { global.dfail('rowner', m, conn); throw false }
toggleSetting(global.opts, 'nyimak', isEnable, type, isAll, m)
break
...
isAll = true
if (!isOwner) { global.dfail('owner', m, conn); throw false }
toggleSetting(bot, 'antiSpam2', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'antiTraba', isEnable, type, isAll, m)
break
...
toggleSetting(chat, 'simi', isEnable, type, isAll, m)
break      

case 'swonly': case 'statusonly':
isAll = true
if (!isROwner) { global.dfail('rowner', m, conn); throw false }
toggleSetting(global.opts, 'swonly', isEnable, type, isAll, m)
break
